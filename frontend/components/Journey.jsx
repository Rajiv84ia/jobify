...
const Journey = () => {
  return (
    <section className=" min-h-screen flex flex-col items-center justify-center">
        <h1 className=" font-semibold text-2xl text-center md:text-4xl lg:text-4xl">Navigate Your Career Journey with <Link href="/blogs" className=" text-[#FF70C1] cursor-pointer">
        Jobify's Blog
        </Link></h1>
