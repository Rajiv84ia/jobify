...
const JobCard = () => {
  ...
  return (
    <div className=" rounded-lg p-4 bg-[#F9F6FE] flex flex-col gap-3 w-full">
        ...
        <h1 className=' font-bold text-xl md:text-2xl'>Sr. Software Developer</h1>
        ...
        <div className=' bg-white p-2 flex flex-wrap items-center justify-between rounded-md gap-2'>
